...
public class SharedPreferencesUtil {
    private static final String LOGIN_INFO = "loginInfo";//登录信息
    public static final String LOGIN_STATUS = "loginStatus";//登录信息
    public static final String longitude = "longitude";
    public static final String latitude = "latitude";
    public static final String USER_ID = "userId";
    public static final String OASSWORD = "passWord";
    public static final String BALANCE = "balance";
    public static final String WX_PAYMENT_SN = "wx_payment_sn";
    public static final String THIRD_IS_BANDING="isBanding";
    public static final String THIRD_IMG_URL = "third_img_url";
